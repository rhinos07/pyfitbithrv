...
class Fitbit(object):
    ...
    def get_hrv(self, date):
        ...
        date should be a datetime.date object.
        """
        url = "{0}/{1}/user/-/hrv/date/{year}-{month}-{day}.json".format(
            *self._get_common_args(),
            year=date.year,
    ...
    def get_br(self, date):
        """

        date should be a datetime.date object.
        """
        url = "{0}/{1}/user/-/br/date/{year}-{month}-{day}.json".format(
            *self._get_common_args(),
            year=date.year,
            month=date.strftime('%m'),
            day=date.strftime('%d')
    ...
    def get_cardioscore(self, date):
        """
        https://dev.fitbit.com/docs/sleep/#get-sleep-logs
        date should be a datetime.date object.
        """
        url = "{0}/{1}/user/-/cardioscore/date/{year}-{month}-{day}.json".format(
            *self._get_common_args(),
            year=date.year,
            month=date.month,
            day=date.strftime('%d')
